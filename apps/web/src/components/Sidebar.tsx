...
const navigation = [
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M2 5h12M10 2l3 3-3 3M14 11H2M6 8l-3 3 3 3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M8 1.5V8l4.5 2.6" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M1 12V5a1 1 0 011-1h12a1 1 0 011 1v7a1 1 0 01-1 1H2a1 1 0 01-1-1z" />
        <path d="M1 8h14M5 8v5M11 8v5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M2 13V7M6 13V4M10 13V6M14 13V2" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    <aside className="w-56 bg-[#09090b] flex flex-col flex-shrink-0">
      ...
      <div className="px-5 pt-7 pb-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="font-display font-700 text-white text-sm tracking-wide leading-none">AERIS</p>
